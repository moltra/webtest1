                    Bitnami WordPress Stack 4.5.3-0
                  ==============================
...
bitnami-wordpress-4.5.3-0-linux-installer.run on Linux or
bitnami-wordpress-4.5.3-0-linux-x64-installer.run on Linux 64 bit or
bitnami-wordpress-4.5.3-0-windows-installer.exe on Windows or
bitnami-wordpress-4.5.3-0-osx-x64-installer.dmg on OS X.

On Linux, you will need to give it executable permissions:

chmod 755 bitnami-wordpress-4.5.3-0-linux.run
...
in /home/user/wordpress-4.5.3-0 on Linux or 
C:\Bitnami\wordpress-4.5.3-0 on Windows or 
/Applications/wordpress-4.5.3-0 on OS X and that you use port 8080 
...
/home/user/wordpress-4.5.3-0/apache2/logs/error.log on Linux or
C:\bitnami\wordpress-4.5.3-0\apache2\logs\error.log on Windows or
/Applications/wordpress-4.5.3-0/apache2/logs/error.log.
